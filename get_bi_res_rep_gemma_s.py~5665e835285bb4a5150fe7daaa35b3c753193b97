...
layer_num = 28
res_rep_str = f"gemma_3_{args.model_size}_bi_res_rep_{layer_num}_avg100"
model_id = f'/mnt/petrelfs/lihao1/trustai/share/models/google/gemma-3-{args.model_size}-it'
...
def alpaca_data_process(data, is_alpaca = True):
    ...
    with torch.inference_mode():
        ...
        rep = model(input_ids).hidden_states[layer_num][0][-1].cpu()
    return rep
