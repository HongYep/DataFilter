...
# logits_str = 'inst_rep_res' if res_logits else 'inst_rep'
logits_str = 'with_system_inst'
...
safe_rep = torch.stack([safe_data_process(data) for data in tqdm(safe_data , desc='safe_datas')])
