...
if __name__ == '__main__':
    ...
    parser.add_argument('--logits_str', type=str, default='OncoGPT')
    parser.add_argument('--input_json', type=str, default='data/Med/OncoGPT-sample_clean.json')
    args = parser.parse_args()
    logits_str = args.logits_str + "_inst" if res_logits else args.logits_str
    ...
    safe_rep = torch.stack([alpaca_data_process(data, is_alpaca= False) for data in tqdm(safe_data , desc='safe_datas')])
