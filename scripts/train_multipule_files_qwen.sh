...
python /mnt/petrelfs/luzhenghao/safe_useful/train_qwen.py --data_path ${data_dir}/${file}_bottom_1000.json --output_path ${output_dir}/${file}_bottom_1000
EOF
...
python /mnt/petrelfs/luzhenghao/safe_useful/train_qwen.py --data_path ${data_dir}/${file}_top_1000.json --output_path ${output_dir}/${file}_top_1000
EOF
    sbatch "debug_${file}.sh"
done