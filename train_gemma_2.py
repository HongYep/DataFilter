...
model = AutoModelForCausalLM.from_pretrained('/mnt/petrelfs/share_data/ai4good_shared/models/google/gemma-2-9b-it', device_map="auto", trust_remote_code = True)
model.enable_input_require_grads()  # 开启梯度检查点
tokenizer = AutoTokenizer.from_pretrained('/mnt/petrelfs/share_data/ai4good_shared/models/google/gemma-2-9b-it', use_fast=False, trust_remote_code = True)
...
# data/alpaca_data_cleaned_llama_score_bottom_1000.json
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_path', type=str, default='llama_sort_results/alpaca-gpt4_wild_score_top_1000.json')
    parser.add_argument('--output_path', type=str, default='gemma_2_output/alpaca-gpt4_wild_score_top_1000')
