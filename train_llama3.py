...
model = AutoModelForCausalLM.from_pretrained('/mnt/petrelfs/share_data/safety_verifier/models/Meta-Llama-3-8B-Instruct', device_map="auto")
model.enable_input_require_grads()  # 开启梯度检查点
tokenizer = AutoTokenizer.from_pretrained('/mnt/petrelfs/share_data/safety_verifier/models/Meta-Llama-3-8B-Instruct', use_fast=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='llama_sort_results/llama_bi_res_rep_avg100_mean_top_1000.json')
    parser.add_argument('--output_path', type=str, default='llama_output/llama_bi_res_rep_avg100_mean_top_1000')
